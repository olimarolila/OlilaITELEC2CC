...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div className="footer-esrb">
        <div className="esrb-rating">
          <img src="/public/esrb-rating.png" alt="ESRB Rating" />
          <ul>
            <li>Blood</li>
            <li>Language</li>
            <li>Violence</li>
